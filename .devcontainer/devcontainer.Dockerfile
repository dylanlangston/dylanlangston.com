...
RUN apt-get update && export DEBIAN_FRONTEND=noninteractive \
     && apt-get -y install --no-install-recommends ca-certificates bash curl unzip xz-utils make git python3 pip glslang-tools nodejs npm awscli pkg-config netcat-traditional
